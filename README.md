# YasinRelay Core v2 (v2.0.0 Stable Release)

پلی بین کانال‌های تلگرام و ایتا: محتوا را دریافت می‌کند، با AI پردازش می‌کند، و در یک کانال ایتا منتشر می‌کند. نسخه پایدار ۲.۰.۰ شامل بهینه‌سازی‌های جامع امنیتی، سازگاری کامل با اکوسیستم Yasin و بهبود معماری پایپ‌لاین پیام‌رسانی است.
